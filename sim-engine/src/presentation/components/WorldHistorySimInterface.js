    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Elder Marcus */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-2xl">🧙‍♂️</span>
              <div>
                <h4 className="font-semibold text-blue-900 dark:text-blue-100">Elder Marcus</h4>
                <p className="text-xs text-blue-700 dark:text-blue-300">Village Elder, 67 years</p>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div>
                <span className="font-medium text-blue-800 dark:text-blue-200">Traits:</span>
                <span className="text-blue-700 dark:text-blue-300 ml-1">Wise, Patient, Protective</span>
              </div>
              <div>
                <span className="font-medium text-blue-800 dark:text-blue-200">Goals:</span>
                <span className="text-blue-700 dark:text-blue-300 ml-1">Village Safety, Knowledge Preservation</span>
              </div>
              <div>
                <span className="font-medium text-blue-800 dark:text-blue-200">Location:</span>
                <span className="text-blue-700 dark:text-blue-300 ml-1">Village Square</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 rounded-lg p-4 border border-green-200 dark:border-green-700">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="font-semibold text-green-900 dark:text-green-100">Lynn the Trader</h4>
                <p className="text-xs text-green-700 dark:text-green-300">Merchant, 34 years</p>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div>
                <span className="font-medium text-green-800 dark:text-green-200">Traits:</span>
                <span className="text-green-700 dark:text-green-300 ml-1">Shrewd, Friendly, Ambitious</span>
              </div>
              <div>
                <span className="font-medium text-green-800 dark:text-green-200">Goals:</span>
                <span className="text-green-700 dark:text-green-300 ml-1">Profit, Reputation, Adventure</span>
              </div>
              <div>
                <span className="font-medium text-green-800 dark:text-green-200">Location:</span>
                <span className="text-green-700 dark:text-green-300 ml-1">Merchant Quarter</span>
              </div>
            </div>
          </div>

          {/* Captain Thor */}
          <div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900 dark:to-orange-900 rounded-lg p-4 border border-red-200 dark:border-red-700">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-2xl">⚔️</span>
              <div>
                <h4 className="font-semibold text-red-900 dark:text-red-100">Captain Thor</h4>
                <p className="text-xs text-red-700 dark:text-red-300">Guard Captain, 42 years</p>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div>
                <span className="font-medium text-red-800 dark:text-red-200">Traits:</span>
                <span className="text-red-700 dark:text-red-300 ml-1">Loyal, Stern, Protective</span>
              </div>
              <div>
                <span className="font-medium text-red-800 dark:text-red-200">Goals:</span>
                <span className="text-red-700 dark:text-red-300 ml-1">Duty, Honor, Village Defense</span>
              </div>
              <div>
                <span className="font-medium text-red-800 dark:text-red-200">Location:</span>
                <span className="text-red-700 dark:text-red-300 ml-1">Village Square</span>
              </div>
            </div>
          </div>

          {/* Old Willow */}
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900 dark:to-violet-900 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-2xl">🌲</span>
              <div>
                <h4 className="font-semibold text-purple-900 dark:text-purple-100">Old Willow</h4>
                <p className="text-xs text-purple-700 dark:text-purple-300">Forest Hermit, 156 years</p>
              </div>
            </div>
            <div className="space-y-2 text-sm">
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">Traits:</span>
                <span className="text-purple-700 dark:text-purple-300 ml-1">Mysterious, Wise, Reclusive</span>
              </div>
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">Goals:</span>
                <span className="text-purple-700 dark:text-purple-300 ml-1">Nature Protection, Ancient Knowledge</span>
              </div>
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">Location:</span>
                <span className="text-purple-700 dark:text-purple-300 ml-1">Forest Edge</span>
              </div>
            </div>
          </div>
        </div>

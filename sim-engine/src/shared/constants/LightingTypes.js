/**
 * Lighting type constants for environmental system
 * Defines all available lighting conditions for nodes
 */
 ...
 */
export const LIGHTING_TYPE_VALUES = Object.values(LightingTypes);
 ...
 */
export const LIGHTING_INTENSITY = {
 ...
 */
export const LIGHTING_VISIBILITY_MODIFIERS = {
 ...
 */
export const LIGHTING_STEALTH_MODIFIERS = {
 ...
 */
export const isValidLightingType = (lightingType) => {
 ...
 */
export const getLightingDescription = (lightingType) => {
 ...
 */
export const getLightingIntensity = (lightingType) => {

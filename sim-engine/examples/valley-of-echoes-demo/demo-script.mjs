...
import oakwoodFederationConfig from './oakwood-federation/config.js';
import ironholdDominionConfig from './ironhold-dominion/config.js';
import multiSettlementQuests from './quests/multi-settlement-quests.js';
import processTurnWithLOD from '../../src/application/use-cases/simulation/ProcessTurnWithLOD.js';
import LODManager from '../../src/domain/services/LODManager.js';
import HistoryGenerator from '../../src/domain/services/HistoryGenerator.js';
...
class ValleyOfEchoesDemo {
  ...
  async buildSettlement(config) {
    ...
    return await this.worldBuilder.build(worldData);
  }
...
export default ValleyOfEchoesDemo;